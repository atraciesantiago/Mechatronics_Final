...
goHome('qr')
resetWorld
disp('Getting Robot and pouch Pose...')
    ...
    model_name = models.ModelNames{12};         % gCan1 is cell {20}  
...
disp('Getting Robot and pouch Pose...')
    ...
    strcmp(type,'gazebo')                       % string compare 
    models = getModels;                         % Extract gazebo model list
    model_name = models.ModelNames{13};         % gCan1 is cell {20}  
    [mat_R_T_G, mat_R_T_M] = get_robot_object_pose_wrt_base_link(model_name); % mat_R_T_M is the translation of robot to the model(gCan1)
...
disp('Getting Robot and pouch Pose...')
    ...
    strcmp(type,'gazebo')                       % string compare 
    models = getModels;                         % Extract gazebo model list
    model_name = models.ModelNames{14};         % gCan1 is cell {20}  
    [mat_R_T_G, mat_R_T_M] = get_robot_object_pose_wrt_base_link(model_name); % mat_R_T_M is the translation of robot to the model(gCan1)
...
disp('Getting Robot and pouch Pose...')
    ...
    strcmp(type,'gazebo')                       % string compare 
    models = getModels;                         % Extract gazebo model list
    model_name = models.ModelNames{15};         % gCan1 is cell {20}  
    [mat_R_T_G, mat_R_T_M] = get_robot_object_pose_wrt_base_link(model_name); % mat_R_T_M is the translation of robot to the model(gCan1)
...
disp('Getting Robot and pouch Pose...')
    ...
    strcmp(type,'gazebo')                       % string compare 
    models = getModels;                         % Extract gazebo model list
    model_name = models.ModelNames{18};         % gCan1 is cell {20}  
    [mat_R_T_G, mat_R_T_M] = get_robot_object_pose_wrt_base_link(model_name); % mat_R_T_M is the translation of robot to the model(gCan1)
